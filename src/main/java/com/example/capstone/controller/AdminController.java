...
//    }
    ...
    public String album(Model model, @RequestParam(value = "code", defaultValue = "") String code) {
        ...
        if (code != null && code.length() > 0) {
            Album album = albumService.getAlbumById(code);
            if (album != null) {
    ...
    public String albumSave(Model model, //
        ...
        try {
            albumService.saveAlbum(albumForm);
        } catch (Exception e) {
...
//        }
//        List<OrderDetailInfo> details = (List<OrderDetailInfo>) this.orderService.getOrderById(orderId);
